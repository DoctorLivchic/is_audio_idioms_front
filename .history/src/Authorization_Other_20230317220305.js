      ...
      if(ValidMail(email1)){
        if(comparePass(password1, passAffirm)){
          ...
          try{
            ...
            .from('user')
            .insert( {role_id : role, name: name1,surname: surname1,patronymic : lastname,passport_series : passport_series1,passport_id : passport_id1,date_of_birth : data1,contact_number : phone_number, diploma_id : diploma_id1 , email: email1, password: password1} )
          }catch (error) {
