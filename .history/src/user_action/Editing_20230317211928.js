  ...
  async function translateFunction(){
    ...
    for (let i=0; i<data.length; i++){
      ...
      if(data[i][chosenLanguage] == firstText){
        document.getElementById("log_rus").value = data[i][translationLanguage_rus];
      }
      if(data[i][chosenLanguage] == firstText){
        document.getElementById("log_fre").value = data[i][translationLanguage_fre];
      }
    }
  }
               ...
               <div className="card-front_Add">
                 <div className="center-wrap">
                   <div className="section text-center">
                     <h4 className="mb">Введите информацию о изменении фразеологизма</h4>
                     ...
                     <Form
                        ...
                        name="language_left"
                        id="language_left"
                        label={<label style={{ color: "white" }}>Выбор языка</label>}>
                    ...
                    <div className="form-group">                  
                     ...
                     <Form.Item>
                         ...
                         <Button onClick={() => {translateFunction()}} className='btn'>Найти</Button>
                     </Form.Item>
                   </div>
                 </div>
               </div>
