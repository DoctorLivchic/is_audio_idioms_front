...
async function GetLike() {
  ...
  console.log(',kf,fkfkfk'+ likes.data[0]['phrase_id'])
  let like = likes.data[0]['rating like'];
  console.log("Лайков в кнопке дб: " + likes.data[0]['rating like'])
  document.getElementById("like").value = likes.data[0]['rating like'];
}

//Функция перевода
async function translateFunction() {

  //Заполняем лайки и дизлайки
  GetLike();
