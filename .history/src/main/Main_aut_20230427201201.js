...
async function translateFunction() {
  ...
  .from('phraseological')
  .update('rating_like',phrase.data[0]['rating_like']+1 )
        ...
        <Content style={contentStyle}>
          ...
          <div className="buttom-block">
            <Form.Item>
              ...
              <Button onClick={likePhrase} id="dislike" icon={<LikeTwoTone />}></Button>
              <Button onClick={dislikePhrase} icon={<DislikeTwoTone />}>2</Button>
