        ...
        <nav>
          <ul className="navig_mod_acc">
            <Form.Item style={{ position: "relative", left: "-2%" }}>
              <Button
                onClick={() => {
                  navigate("/Activity_moderator_and_expert/Activity_moderator");
                }}
                className="btn-7"
              >
              ...
              <Button
                onClick={() => {
                  navigate("/Activity_moderator_and_expert/Manag_of_phrase");
                }}
                className="btn-7"
              >
              ...
              <Button
                onClick={() => {
                  navigate("/Activity_moderator_and_expert/Manag_of_tag");
                }}
                className="btn-7"
              >
              ...
              <Button
                onClick={() => {
                  navigate("/Activity_moderator_and_expert/Manag_of_stat");
                }}
                className="btn-7"
              >
